...
if (!page.includes("lander-records-anuncie-banner.webp")) {
  ...
  page = page.replace(
    newsMarker,
    `</div></section>\n        <img src=\"/lander-records-site/lander-records-anuncie-banner.webp\" alt=\"Anuncie com a Lander Records\" width={1280} height={426} style={{display:\"block\",width:\"100%\",height:\"auto\"}} />\n        <section className=\"homeBlock\"><div className=\"homeBlockHeader\"><div><p className=\"homePortalLabel\">PORTAL LANDER</p>`
  );
}
