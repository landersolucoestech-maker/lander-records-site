  ...
  return (
    <div className="adminPage">
      ...
      <section className={styles.hero}>
        {post.coverImage ? <Image className={styles.portrait} src={post.coverImage} alt={`Imagem principal de ${post.title}`} width={1200} height={675} unoptimized /> : <div className={styles.portrait}>NT</div>}
      ...
      <div className={styles.grid}>
        ...
        <section className={styles.card}><h2>Autor</h2>{post.authorImage ? <Image className={styles.banner} src={post.authorImage} alt={post.authorName} width={800} height={800} unoptimized /> : <p className={styles.empty}>Imagem do autor não cadastrada.</p>}<div className={styles.row}><span>Nome</span><strong>{post.authorName}</strong></div></section>
      </div>

      <section className={styles.card}><h2>Imagem principal</h2>{post.coverImage ? <Image className={styles.banner} src={post.coverImage} alt={`Imagem principal de ${post.title}`} width={1200} height={675} unoptimized /> : <p className={styles.empty}>Imagem principal não cadastrada.</p>}<p className={styles.empty}>A mesma imagem é usada na Home, na página geral de Notícias e no banner da página individual.</p></section>
