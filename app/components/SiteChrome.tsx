...
function YouTubeIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2.5" y="5" width="19" height="14" rx="4"/><path d="M10 9l5 3-5 3z"/></svg>;
}

function TikTokIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14 3v10.2a4.2 4.2 0 1 1-3.2-4.1v2.7a1.8 1.8 0 1 0 .8 1.5V3h2.4c.5 2.1 1.8 3.4 4 3.9v2.5A7.2 7.2 0 0 1 14 7.8"/></svg>;
}

function SpotifyIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 9.2c4.7-1.5 9.8-1.2 14.1.9"/><path d="M6.3 13c3.8-1.1 7.9-.8 11.4.8"/><path d="M7.5 16.5c3-.8 6.1-.5 8.9.6"/></svg>;
}

function SoundCloudIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 15v2M5.3 13.5v5M7.6 12v7M10 10.5v8.5"/><path d="M11.8 18.8h6.3a3.2 3.2 0 0 0 .3-6.4 5.3 5.3 0 0 0-10-1.4"/></svg>;
}
      ...
      <div className="footerMain">
        ...
        <div className="footerColumn footerContact">
          ...
          <div className="footerSocials footerSocialIcons">
            ...
            <a href="#" aria-label="TikTok" title="TikTok"><TikTokIcon /></a>
            <a href="#" aria-label="Spotify" title="Spotify"><SpotifyIcon /></a>
            <a href="#" aria-label="SoundCloud" title="SoundCloud"><SoundCloudIcon /></a>
          </div>
        </div>
      </div>
