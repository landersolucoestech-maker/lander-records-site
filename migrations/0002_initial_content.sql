...
INSERT INTO page_sections (id,page_id,section_key,type,eyebrow,title,subtitle,body,position,enabled) VALUES
 ...
 ('52000000-0000-4000-8000-000000000002','50000000-0000-4000-8000-000000000002','history','split','NOSSA HISTÓRIA','Da produção à gestão artística.','LANDER RECORDS · BRASIL','A Lander Records nasceu para reunir criação, operação e estratégia em torno do desenvolvimento de artistas e projetos musicais.',2,true),
