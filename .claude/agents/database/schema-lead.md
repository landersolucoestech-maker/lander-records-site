---
name: schema-lead
description: "Keep Drizzle table definitions and SQL migrations semantically identical. Use for database work on lander-records-site."
...
## Purpose
Keep Drizzle table definitions and SQL migrations semantically identical.

## Responsibilities
- Detect enum/column drift between TS and SQL
...
- Dispatch subagents: nullability-auditor
...
- `lib/db/artist-management-schema.ts`
- knowledge/architecture.md
- rules/database.md

## Procedures
1. Compare pgEnum values with migrations; run audit-db
...
## Escalation rules
- Drift requiring data change → database-lead
