...
description: "Prove nothing that worked before broke: siblings of touched code and previously passing suites. Use for quality work on lander-records-site."
...
## Purpose
Prove nothing that worked before broke: siblings of touched code and previously passing suites.

## Responsibilities
- Compare suite results with the known-failures baseline
...
## Required context
- `state/known-failures.yml`
- `state/validation-history.yml`
- knowledge/architecture.md
- rules/testing.md

## Procedures
1. Run full npm test and integration; diff failures against state/known-failures.yml
...
## Escalation rules
- New failure → FIXING (self-healing loop)
